...
public class Constant {
	...
	// Elements on Login Pop-up box
	 public static String LoginPopUpBox="div.login-modal";
	  ...
	  public static String Register_Over18Term="a[href='/privacy']";
	  public static String Register_Over18PrivacyPolicy="a[href='/terms']";
	  ...
	  public static String Reg_DepositLimitValueBox="//select[@='edit-deposit-amount']";
