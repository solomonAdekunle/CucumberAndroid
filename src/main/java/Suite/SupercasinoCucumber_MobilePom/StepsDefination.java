...
public class StepsDefination extends TestBase {
	...
	/*
	 * Verify if Green tick or green colour is displayed when correct data is
	 * input
	 */
	...
	/* Verify if Deposit Declined TransactionPop-up is display */
